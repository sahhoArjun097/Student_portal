        ...
        <div className={`w-full h-full p-2 md:p-10 flex flex-col items-center gap-8 ${darkMode ? "bg-gray-900" : "bg-white"}`}>
            <div className="flex flex-col md:flex-row justify-between w-full max-w-6xl">
                ...
                <div>
                    ...
                    <p className={`text-lg font-semibold  ${darkMode ?"text-white":"text-gray-700"} `}>Easy access to Records</p>
                </div>
                ...
                <div className="mt-4 md:mt-0">
                    ...
                    <ul className="mt-2 space-y-1 text-sm">
                        ...
                        <li><a href="/faq" className={`  hover:text-yellow-600 ${darkMode?"text-white":"text-gray-800 "}`}>FAQ</a></li>
                        <li><a href="/login" className={`  hover:text-yellow-600 ${darkMode?"text-white":"text-gray-800 "}`}>Login</a></li>
                        {/* <li><a href="/fee"className={`  hover:text-yellow-600 ${darkMode?"text-white":"text-gray-800 "}`}>Fee</a></li> */}
