...
function Contest() {
  ...
  return (
    <div
      className="w-full mt-18  min-h-screen ${
    ...
    >
      ...
      {/* Contest Grid */}
      <div className="mt-4  w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {contests.length > 0 ? (
          contests.map((contest) => (
            <div
              key={contest._id}
              className={`p-5 rounded-lg shadow-lg border-2 ${darkMode
